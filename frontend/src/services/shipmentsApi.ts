...
export interface ShipmentItem{id:string;persisted:boolean;loadId:string|null;commessa:string;cliente:string;camion:string|null;plannedLoadingDate:string|null;plannedDepartureDate:string|null;originalPlannedDepartureDate:string|null;plannedDepartureDateChangedAt:string|null;actualDepartureDate:string|null;transportType:ShipmentTransportType|null;trailerId:string|null;carrierId:string|null;plannedCarrierId:string|null;notes:string|null;shipmentStatus:ShipmentStatus;operationalStatus:OperationalLoadStatus|null;createdAt:string|null;updatedAt:string|null;}
export interface ShipmentInput{loadId?:string|null;commessa:string;cliente:string;camion?:string|null;plannedLoadingDate?:string|null;plannedDepartureDate?:string|null;transportType?:ShipmentTransportType|null;trailerId?:string|null;carrierId?:string|null;plannedCarrierId?:string|null;notes?:string|null;}
