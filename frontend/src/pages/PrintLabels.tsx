...
interface Props { commesse:Commessa[]; onBack:()=>void; }
const now = () => new Intl.DateTimeFormat("it-IT", { dateStyle:"short", timeStyle:"medium" }).format(new Date());
const initialFields:LabelFields = { anno:String(new Date().getFullYear()), commessa:"", cliente:"", riferimento:"", tipologia:"CLT L3-100", dtp:"Jlenia Pedrotti", operatore:"T.T.", autMin:"59/15-CL", codiceEta:"ETA-12/0362", dataOra:now(), rotate:false };

export default function PrintLabels({ commesse, onBack }:Props) {
  ...
  return <Box>
    <style>{`
      .print-label{width:250mm;height:100mm;background:#fff;color:#151515;border:1px solid #777;padding:6mm 8mm;display:grid;grid-template-columns:26mm 1fr 50mm;grid-template-rows:27mm 1fr;gap:3mm 5mm;position:relative;font:10.5pt Arial,sans-serif;box-sizing:border-box;margin:28px auto;box-shadow:0 4px 18px #0008;transform-origin:center}.label-brand{display:flex;align-items:center;justify-content:center;border-bottom:1.5px solid}.label-logo{width:20mm;height:20mm;background:#000;color:#fff;display:flex;flex-direction:column;align-items:center;justify-content:center}.label-logo small{font-size:5pt;color:#ccc}.label-heading{border-bottom:1.5px solid;display:grid;grid-template-columns:1fr 1.35fr .75fr .8fr;column-gap:5mm;align-items:start}.label-heading>div:not(.heading-ce){display:grid;grid-template-rows:4mm 11mm auto;align-items:start}.label-heading small,.label-details span,.label-codes small{text-transform:uppercase;font-size:7pt;letter-spacing:.04em}.label-heading .heading-value{font-family:Arial,sans-serif;font-size:28pt;font-weight:900;line-height:11mm;white-space:nowrap;align-self:start}.label-heading span{font-size:7.5pt;margin-top:1mm}.label-heading .heading-ce{display:flex;flex-direction:column;align-items:center;justify-content:flex-start;text-align:center;line-height:1.05;padding-top:0}.label-heading .heading-ce>strong{font-size:16pt;font-weight:900;line-height:5mm;margin-bottom:.5mm}.label-heading .heading-ce>b{font-size:7pt;line-height:3mm}.label-heading .heading-ce>small{font-size:5.5pt;line-height:2.5mm;letter-spacing:0;white-space:nowrap}.label-heading .heading-ce>small+ b{margin-top:1mm}.label-details{grid-column:1/3;display:grid;grid-template-columns:40mm 1fr;gap:1.8mm 3mm;align-content:start}.label-details>b{font-size:12pt;border-bottom:1px dotted #aaa;padding-bottom:.7mm}.label-details .large{font-size:14pt}.label-codes{grid-column:3;grid-row:1/3;border-left:1.5px solid;padding-left:4mm;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:2.5mm}.label-codes svg{width:27mm;height:27mm}.label-codes>div{width:100%;border-top:1px solid #ddd;padding-top:1.5mm;text-align:center;display:flex;flex-direction:column}.label-codes>div b{font-size:9pt}.preview-caption{position:absolute;top:-20px;left:0;color:#aaa;font-size:11px}.print-label--rotated{transform:rotate(90deg);margin:82mm auto}@media print{@page{size:250mm 100mm;margin:0}body{background:#fff!important}.no-print,footer{display:none!important}.labels-preview{padding:0!important}.print-label{box-shadow:none;border:0;margin:0;break-after:page;page-break-after:always}.print-label--rotated{transform:rotate(90deg);margin:75mm auto}.preview-caption{display:none!important}}
    `}</style>
