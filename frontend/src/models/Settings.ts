...
export interface VoceTrasporto { id:string; nome:string; attivo:boolean; }
export interface ImpostazioneOperativa { chiave:string; valore:string; descrizione:string; attivo:boolean; }
export interface SettingsData { operatori:Operatore[]; rimorchi:Rimorchio[]; trasportatori:Trasportatore[]; tipiMezzoCliente:VoceTrasporto[]; modalitaTerziEssepi:VoceTrasporto[]; listeOperative:ImpostazioneOperativa[]; }
