...
export interface CaricoCamion{loadId:string;commessa:string;cliente:string;camion:string;stato:StatoCaricoOperativo;rimorchioId?:string;trasportatoreId?:string;operatoreId:string;operatore:string;avviatoIl:string;completatoIl?:string;scansioni:ScansioneCarico[];eventi:EventoCarico[];}
