...
export interface ScansioneCarico{unitId?:string;panelId?:string;packageId?:string;tipoUnita:TipoUnitaCarico;codiceUnita:string;commessa:string;camion:string;operatoreId:string;operatore:string;dataOra:string;peso:number;volume:number;esito:"OK";}
export interface CaricoCamion{transportMode?:"BILICO_ESSEPI"|"RITIRA_CLIENTE"|"TERZI_PER_ESSEPI"|null;transportDetailId?:string|null;transportDetailLabel?:string|null;loadId:string;backendLoadId?:string;commessa:string;cliente:string;camion:string;stato:StatoCaricoOperativo;tipoDestinazione?:TipoDestinazioneCarico;rimorchioId?:string;trasportatoreId?:string;operatoreId:string;operatore:string;avviatoIl:string;completatoIl?:string;speditoIl?:string;scansioni:ScansioneCarico[];eventi:EventoCarico[];}
