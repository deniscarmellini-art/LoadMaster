...
const bodySchema={type:"object",additionalProperties:false,required:["plate","description"],properties:{...commonProperties,plate:{type:"string",minLength:1,maxLength:50},description:{type:"string",maxLength:300}}} as const;
